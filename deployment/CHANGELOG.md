...
- `1.6.0`
  ...
  - Request workflow safeguards: capped borrow requests at 50 unique items while leaving per-line quantities unchanged, and hardened assign/release/return actions so large requests show inline loading states and temporarily disable repeated actions during pre-submit loading and processing
